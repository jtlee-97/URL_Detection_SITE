            ...
            <div class="area">
                <div class="area_area">
                    ...
                    <?php
                        ...
                        {
                            $new_page = $page-1;
                            echo "<li><a href='board_report_list.php?page=$new_page'>◀ 이전</a> </li>";
                        }		
                        else 
                            echo "<li>&nbsp;</li>";
                        ...
                        for ($i=1; $i<=$total_page; $i++)
                        {
                            ...
                            {
                                echo "<li><a href='board_report_list.php?page=$i'> $i </a><li>";
                            }
                        }
                        if ($total_page>=2 && $page != $total_page)		
                        {
                            $new_page = $page+1;	
                            echo "<li> <a href='board_report_list.php?page=$new_page'>다음 ▶</a> </li>";
                        }
                        else 
                            echo "<li>&nbsp;</li>";
                    ?>
